    ...
    <div class="plain error-page-wrapper background-color background-image">
      <div class="content-container">
        ...
        <div class="context primary-text-color">
          ...
          <p>
            You may want to turn that wagon around and head on back to the homepage.<br />
            If you think something is broken or just ...off..., report a problem.
          </p>
        </div>
        <div class="buttons-container">
          <a class="border-button" href="http://generationlatinx.com" target="_blank">Go To Homepage</a>
          <a class="border-button" href="mailto:generationlatinx@gmail.com" target="_blank">Report A Problem</a>
        </div>
      </div>
    </div>
  </div>
...
.background-color {
  background-color: rgba(252, 192, 49, 1) !important;
}
...
.secondary-text-color {
  color: rgba(151, 53, 170, 1) !important;
}
...
.border-button {
  color: rgba(151, 53, 170, 1) !important;
  border-color: rgba(151, 53, 170, 1) !important;
}
.button {
  background-color: rgba(151, 53, 170, 1) !important;
  color:  !important;
}
